...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2016 at 10:46 AM
...
CREATE TABLE IF NOT EXISTS `buy_product` (
  ...
  `pr_brand` varchar(200) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_attachment` (
  ...
  `byteSize` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `employees` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(120) NOT NULL DEFAULT '0',
  `employee_category_id` int(11) DEFAULT NULL,
  `employee_number` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `joining_date` date DEFAULT NULL,
  `first_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `groups` (
  ...
  `users_ids` varchar(120) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `mailbox_conversation` (
  ...
  `initiator_id` int(10) NOT NULL DEFAULT '0',
  `interlocutor_id` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `subject` varchar(120) DEFAULT NULL,
  `msg_content` text,
  `msg_uploads` varchar(120) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `transportation` (
  ...
  `is_paid` int(20) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
