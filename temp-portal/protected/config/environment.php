...
define('BASEURL', 'http://www.chalotrustschool.com/temp-portal');

//Database connections
define('DB_CONNECTION','mysql:host=localhost;port=3306;dbname=m6n7p1u0_openschool_test');
define('DB_USER','m6n7p1u0_lombe');
define('DB_PWD','pbomber');
