...
<!--
	...
	END SLIDER SECTION COMMENTED OUT -->
	<div class="indexContainer grayContainer welcomeContainer">
		<div class="welcome"> <span class="bigWelcome">WELCOME TO<br>OUR WORLD</span>
			<!-- TYPING ANIMATION COMMENTED OUT
			<span class="introWelcome"><div id="introTypeIt"></div> </span>
			END TYPING ANIMATION COMMENTED OUT -->
			<span class="introWelcome">
				<p>Chalo Trust School is an independent educational establishment located in Lusaka, Zambia that offers world-class primary and secondary education at an affordable price. Our curriculum prepares students for adulthood and higher education, and we take pride in producing well-rounded, high quality students. The school is located in a quiet and natural environment conducive for learning and studying.</p>
				<p><em>Our mission is to create an environment of order, truth, caring, and concern where students of diverse economic and cultural backgrounds learn to live together and begin the habit of life long learning and personal and spiritual development.</em></p>
			</span>
